...
public class ApiServiceA : BaseApiService
{
    private readonly ServiceRegistry _serviceRegistry;
    public override string ServiceName => ServiceNames.ServiceA;

    public ApiServiceA(IEnumerable<IApiAction> actions, ITaskManager taskManager, ILoggingService loggingService, ServiceRegistry serviceRegistry)
